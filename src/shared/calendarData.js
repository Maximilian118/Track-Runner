...
export const calendarData = () => {
  ...
  return calArr.map(date => {
    if (moment(date.date).isAfter("2021-08-10T00:00:00+00:00") && moment(date.date).isBefore("2021-08-17T00:00:00+00:00")) {
      return {
        ...date, 
    ...
    } else if (moment(date.date).isAfter("2021-08-24T00:00:00+00:00") && moment(date.date).isBefore("2021-08-31T00:00:00+00:00")) {
      return {
        ...date, 
    ...
    } else if (moment(date.date).isAfter("2021-08-31T00:00:00+00:00") && moment(date.date).isBefore("2021-09-07T00:00:00+00:00")) {
      return {
        ...date, 
    ...
    } else if (moment(date.date).isAfter("2021-09-07T00:00:00+00:00") && moment(date.date).isBefore("2021-09-14T00:00:00+00:00")) {
      return {
        ...date, 
        location: "Mugello Circuit", 
        img: "https://book4track.com/pub/media/lof/seller/Mugello_Circuit.jpg",
      }
    } else if (moment(date.date).isAfter("2021-09-21T00:00:00+00:00") && moment(date.date).isBefore("2021-09-28T00:00:00+00:00")) {
      return {
        ...date, 
        location: "Sochi Autodrom", 
        img: "https://static.tildacdn.com/tild3263-3338-4537-b037-653430326665/2018-05-17_09-35-13.png",
      }
    } else if (moment(date.date).isAfter("2021-10-05T00:00:00+00:00") && moment(date.date).isBefore("2021-10-12T00:00:00+00:00")) {
      return {
        ...date, 
        location: "Nürburgring", 
        img: "https://pbs.twimg.com/profile_images/2504045977/wsb13l05s8wpb07jll89_400x400.jpeg",
      }
    } else if (moment(date.date).isAfter("2021-10-12T00:00:00+00:00") && moment(date.date).isBefore("2021-10-19T00:00:00+00:00")) {
      return {
        ...date, 
    ...
    } else if (moment(date.date).isAfter("2021-10-26T00:00:00+00:00") && moment(date.date).isBefore("2021-11-02T00:00:00+00:00")) {
      return {
        ...date, 
        location: "Autodromo Enzo e Dino Ferrari", 
        img: "https://s3.amazonaws.com/gt7sp-prod/decal/44/93/12/5837329235603129344_1.png",
      }
    } else if (moment(date.date).isAfter("2021-11-09T00:00:00+00:00") && moment(date.date).isBefore("2021-11-16T00:00:00+00:00")) {
      return {
        ...date, 
        location: "Shanghai International Circuit", 
        img: "https://cdn.shopify.com/s/files/1/2318/5725/products/shanghailogo_1024x1024.jpg?v=1544215890",
      }
    } else if (moment(date.date).isAfter("2021-11-16T00:00:00+00:00") && moment(date.date).isBefore("2021-11-23T00:00:00+00:00")) {
      return {
        ...date, 
    ...
    } else if (moment(date.date).isAfter("2021-11-30T00:00:00+00:00") && moment(date.date).isBefore("2021-12-07T00:00:00+00:00")) {
      return {
        ...date, 
        location: "Bahrain International Circuit", 
        img: "https://upload.wikimedia.org/wikipedia/en/d/d1/Bahrain_International_Circuit_logo.png",
      }
    } else if (moment(date.date).isAfter("2021-12-07T00:00:00+00:00") && moment(date.date).isBefore("2021-12-14T00:00:00+00:00")) {
      return {
        ...date, 
